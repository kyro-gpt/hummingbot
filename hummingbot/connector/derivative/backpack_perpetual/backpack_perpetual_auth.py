"""
Backpack Perpetual Exchange Authentication Module

This module provides authentication functionality for the Backpack Perpetual Exchange API
using Ed25519 signatures, ported from the Rust bpx-api-client implementation.

100% reused from spot trading with updated imports and constants.
"""
...
class BackpackPerpetualAuth(AuthBase):
    """
    Authentication handler for Backpack Perpetual Exchange API using Ed25519 signatures.
    ...
    Identical implementation to spot trading - Ed25519 signing works for all Backpack endpoints.
    """
    ...
    def __init__(self, api_key: str, secret_key: str, time_provider=None):
        """
        Initialize the BackpackPerpetualAuth instance.
    ...
    def websocket_login_parameters(self) -> Dict[str, Any]:
        """
        Generate WebSocket authentication parameters for Backpack Perpetual.
